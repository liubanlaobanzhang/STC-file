...
### <img src="https://img.shields.io/badge/难-ff0000" height="21"> 题目的含义
...
先 **概括一下主要内容** ，再回答 **文章主旨** 或者 **内在领悟**，简单分析一下题目意思，然后随便搞点什么 **重点词解释** 一类的（反正多写不扣分对吧，乐），尽量把答题卡写满，赚点辛苦分（bushi
...
|角度|答题示例 <img src="https://img.shields.io/badge/例-模拟试题三-ef632b" height="20">|
|-|-|
|点明 **欲扬先抑**|运用欲扬先抑的写作手法，|
|点明前后文 **对比**|将前文她对母亲的不满与后文她理解母亲对比，|
|突出表现内容|突出了母亲对她的爱和她对母亲的理解，|
|<img src="https://img.shields.io/badge/套话-fba414" height="20"> 使文章波澜起伏|同时也使文章波澜起伏。

<details>
<summary>

## <img src=https://i0.hdslb.com/bfs/emote/7145cbd5464b14a3f5cf544125a9976e44a13517.png@112w_112h.webp height='35px'> 老六答法
